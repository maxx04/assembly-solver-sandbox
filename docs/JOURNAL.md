# Assembly-Modul: Entwicklungsjournal (chronologisch)

> **Für den aktuellen Ist-Zustand siehe [ARCHITECTURE.md](ARCHITECTURE.md)** - dieses Dokument ist
> ab jetzt reine Chronik (wird nur noch ergänzt, nicht mehr als Nachschlagewerk gepflegt). Ursprünglich
> als "Architektur-Überblick" begonnen (siehe Titel unten), 2026-09-05 aufgeteilt, weil ein
> 3665-Zeilen-Journal für schnelles Nachschlagen ungeeignet ist.
